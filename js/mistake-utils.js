...
export function extractWrongChars(wrongChars, fallbackLevel = '', fallbackUnit = '') {
  return normalizeWrongCharEntries(wrongChars, fallbackLevel, fallbackUnit).map((item) => item.char);
}
